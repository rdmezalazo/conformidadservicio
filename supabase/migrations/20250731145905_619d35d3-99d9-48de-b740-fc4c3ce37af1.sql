-- Función para eliminar usuarios específicos de autenticación manteniendo datos de empresa
CREATE OR REPLACE FUNCTION public.delete_auth_users_keep_empresa(user_emails text[])
...
BEGIN
  ...
  IF NOT public.has_role(auth.uid(), 'admin') THEN
    RAISE EXCEPTION 'Solo los administradores pueden eliminar usuarios de autenticación';
  END IF;
...
SELECT * FROM public.delete_auth_users_keep_empresa(
